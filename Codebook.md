...
subject The subject ID, numbered 1-30, each number corresponding to a unique volunteer.

Next, we have the mean and standard deviation of various measurements:

Note: t denotes time while f indicate frequency domain signals
mean = mean, std = standard deviation
Acceleration signals separated into Body and Gravity acceleration signals
